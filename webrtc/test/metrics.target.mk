...
# Add target alias
.PHONY: metrics
metrics: $(builddir)/libmetrics.a

# Copy this to the static library output path.
$(builddir)/libmetrics.a: TOOLSET := $(TOOLSET)
$(builddir)/libmetrics.a: $(obj).target/webrtc/test/libmetrics.a FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/libmetrics.a
# Short alias for building this static library.
.PHONY: libmetrics.a
libmetrics.a: $(obj).target/webrtc/test/libmetrics.a $(builddir)/libmetrics.a

# Add static library to "all" target.
.PHONY: all
all: $(builddir)/libmetrics.a
