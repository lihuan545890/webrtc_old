...
extern void CBAudPlayFrame(unsigned char *buf, unsigned int len);
extern void CBAudCapFrame(unsigned char *buf, unsigned long len);
        ...
        WebRtc_UWord32& newMicLevel)
{
	...
	CBAudCapFrame((unsigned char *)nSamples, sizeof(WebRtc_Word16) * (nSamples * nChannels));    
        ...
        WebRtc_UWord32& nSamplesOut)
{
    ...
    CBAudPlayFrame((unsigned char *)audioSamples, sizeof(WebRtc_Word16) * (nSamples * nChannels));
                      ...
                      AudioProcessing* audioproc)
{
    ...
    if (_shared->audio_device()->SetPlayoutDevice(0) != 0)
//            WEBRTC_VOICE_ENGINE_DEFAULT_DEVICE) != 0)
    ...
    if (_shared->audio_device()->SetRecordingDevice(0) != 0)
//            WEBRTC_VOICE_ENGINE_DEFAULT_DEVICE) != 0)
    {
