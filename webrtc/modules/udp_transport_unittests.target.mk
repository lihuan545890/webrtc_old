...
$(OBJS): | $(builddir)/libudp_transport.a $(builddir)/libgtest.a $(builddir)/libgmock.a $(builddir)/libtest_support_main.a $(builddir)/libsystem_wrappers.a $(builddir)/libcpu_features_android.a $(obj).target/testing/gtest_prod.stamp $(builddir)/libtest_support.a $(obj).target/webrtc/modules/libudp_transport.a $(obj).target/testing/libgtest.a $(obj).target/testing/libgmock.a $(obj).target/webrtc/test/libtest_support_main.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a $(obj).target/webrtc/system_wrappers/source/libcpu_features_android.a $(obj).target/webrtc/test/libtest_support.a
...
$(builddir)/udp_transport_unittests: LD_INPUTS := $(OBJS) $(obj).target/webrtc/modules/libudp_transport.a $(obj).target/testing/libgtest.a $(obj).target/testing/libgmock.a $(obj).target/webrtc/test/libtest_support_main.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a $(obj).target/webrtc/system_wrappers/source/libcpu_features_android.a $(obj).target/webrtc/test/libtest_support.a
$(builddir)/udp_transport_unittests: TOOLSET := $(TOOLSET)
$(builddir)/udp_transport_unittests: $(OBJS) $(obj).target/webrtc/modules/libudp_transport.a $(obj).target/testing/libgtest.a $(obj).target/testing/libgmock.a $(obj).target/webrtc/test/libtest_support_main.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a $(obj).target/webrtc/system_wrappers/source/libcpu_features_android.a $(obj).target/webrtc/test/libtest_support.a FORCE_DO_CMD
	$(call do_cmd,link)
