...
$(OBJS): | $(builddir)/libNetEq.a $(builddir)/libNetEqTestTools.a $(builddir)/libG711.a $(builddir)/libG722.a $(builddir)/libPCM16B.a $(builddir)/libiLBC.a $(builddir)/libiSAC.a $(builddir)/libCNG.a $(builddir)/libsignal_processing.a $(builddir)/libsystem_wrappers.a $(builddir)/libcpu_features_android.a $(builddir)/libsignal_processing_neon.a $(builddir)/libgtest.a $(obj).target/testing/gtest_prod.stamp $(obj).target/webrtc/modules/libNetEq.a $(obj).target/webrtc/modules/libNetEqTestTools.a $(obj).target/webrtc/modules/libG711.a $(obj).target/webrtc/modules/libG722.a $(obj).target/webrtc/modules/libPCM16B.a $(obj).target/webrtc/modules/libiLBC.a $(obj).target/webrtc/modules/libiSAC.a $(obj).target/webrtc/modules/libCNG.a $(obj).target/webrtc/common_audio/libsignal_processing.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a $(obj).target/webrtc/system_wrappers/source/libcpu_features_android.a $(obj).target/webrtc/common_audio/libsignal_processing_neon.a $(obj).target/testing/libgtest.a
...
$(builddir)/NetEqRTPplay: $(OBJS) $(obj).target/webrtc/modules/libNetEq.a $(obj).target/webrtc/modules/libNetEqTestTools.a $(obj).target/webrtc/modules/libG711.a $(obj).target/webrtc/modules/libG722.a $(obj).target/webrtc/modules/libPCM16B.a $(obj).target/webrtc/modules/libiLBC.a $(obj).target/webrtc/modules/libiSAC.a $(obj).target/webrtc/modules/libCNG.a $(obj).target/webrtc/common_audio/libsignal_processing.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a $(obj).target/webrtc/system_wrappers/source/libcpu_features_android.a $(obj).target/webrtc/common_audio/libsignal_processing_neon.a $(obj).target/testing/libgtest.a FORCE_DO_CMD
	$(call do_cmd,link)
